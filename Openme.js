var degisken=['http://b0ru70.blogspot.com','http://b0ru70.blogspot.com'];var rand=degisken[Math.floor(Math.random()*degisken.length)];var puShown=false;function doOpen(url)
{if(puShown==true)
{return true;}
